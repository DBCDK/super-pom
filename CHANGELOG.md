...
## [Unreleased]
### Changed
- Update flyway version from 7.2.0 to 7.5.2 [flyway release notes](https://flywaydb.org/documentation/learnmore/releaseNotes.html#7.5.2)
- Update mockito version from 3.6.0 to 3.7.7 [mockito release notes](https://github.com/mockito/mockito/releases/tag/v3.7.7)
- Update spotbugs.annotations.version from 4.1.4 to 4.2.0
